...
const uint8_t caldaiaPin= D7;  //pin collegato all'ex termostato//era D4 ma conflitto con TXD e faceva scattare rele
const uint8_t acquaPin= D6;    //pin collegato al micro dell'acqua sanitaria
